...
便携版是命令行版的简单版本，**只保留好友对话与添加好友**，不包含群聊、文件、拉黑等其余功能，适合快速轻量使用。

```bash
# 在同项目目录下运行
npm run portable

# 或安装为全局命令（在 portable 目录下）
cd portable && npm install && npm link
