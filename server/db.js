...
function migrateUsersTable() {
  try {
    ...
    if (tableInfo && tableInfo.sql.includes('ip TEXT UNIQUE')) {
      ...
      db.exec('CREATE TABLE users_new (id INTEGER PRIMARY KEY AUTOINCREMENT, ip TEXT NOT NULL, username TEXT NOT NULL, created_at DATETIME DEFAULT (datetime(\'now\',\'localtime\')))');
